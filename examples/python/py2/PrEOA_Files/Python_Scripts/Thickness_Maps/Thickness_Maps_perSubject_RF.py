...
T_M = dirname_read + name + "_R_F_THICK_MED_REG.AIM"
T_L = dirname_read + name + "_R_F_THICK_LAT_REG.AIM"
TC_M = dirname_read + name + "_R_FC_THICK_MED_REG.AIM"
TC_L = dirname_read + name + "_R_FC_THICK_LAT_REG.AIM"
