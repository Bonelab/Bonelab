...
T_M = dirname_read + name + "_L_T_THICK_MED_REG.AIM"
T_L = dirname_read + name + "_L_T_THICK_LAT_REG.AIM"
TC_M = dirname_read + name + "_L_TC_THICK_MED_REG.AIM"
TC_L = dirname_read + name + "_L_TC_THICK_LAT_REG.AIM"
...
#Write out image of thickness maps
plot = plt.figure()
...
plt.imshow(transposed_T_M,cmap= "jet", vmin=-0, vmax= 3) #max_value_T_M)
cbar = plt.colorbar()
cbar.set_label('Thickness (mm)', rotation=270, labelpad = 20)
