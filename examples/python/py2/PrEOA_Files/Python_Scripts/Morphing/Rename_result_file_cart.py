...
name = basename.split("sca")[0]
end = "Morph_roi.mha"
end2 = "Morph_roi.png"
end3 = "transformation.txt"
...
filename3 = "/Users/jbhatla/Documents/UofC/PrEOA/Analysis/Morphing/Thickness_Map_Morphed/" + name + end3
filenameLpng = "/Users/jbhatla/Documents/UofC/PrEOA/Analysis/Morphing/Thickness_Map_PNG/" + name + end2
print filename2

#Rename transformation matrix and transformed file
os.rename(filename, filename2)
os.rename("/Users/jbhatla/Documents/UofC/PrEOA/Analysis/Morphing/Thickness_Map_Morphed/TransformParameters.0.txt", filename3)
...
plt.imshow(final_imageL,cmap= "nipy_spectral", vmin=-0, vmax=5000)
cbar = plt.colorbar()
