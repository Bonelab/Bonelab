...
while (sample_number <= end):
    ...
    while (sample_number <= end):
        if sample_number < 10:
            filename_original_bone = dirname_original1 + str(sample_number) + "_L_T_THICK_LAT_Morph_roi.mha"
            filename_original_cart = dirname_original1 + str(sample_number) + "_L_TC_THICK_LAT_Morph_roi.mha"
        else:
            filename_original_bone = dirname_original2 + str(sample_number) + "_L_T_THICK_LAT_Morph_roi.mha"
            filename_original_cart = dirname_original2 + str(sample_number) + "_L_TC_THICK_LAT_Morph_roi.mha"
