...
outputFaimFile = os.path.splitext(inputAimFile)[0] + "_FAL.inp"
...
outputAimFile = os.path.splitext(inputAimFile)[0] + "_CAL_FAL.AIM"
...
hexa = vtkski.vtkskiStructuredPointsToMesh()
...
outputModelFile = os.path.splitext(inputAimFile)[0] + "_model_FAL.vtu"
...
nodesFileShaft = os.path.splitext(inputAimFile)[0] + "_shaft_nodes_FAL.vtu"
...
depthFilteredBoneNodesFile = os.path.splitext(inputAimFile)[0] + "_nodes_troch_FAL.vtu"
writer = vtk.vtkXMLUnstructuredGridWriter()
...
# Save to file so we can examine in ParaView, etc...
depthFilteredBoneNodesFile = os.path.splitext(inputAimFile)[0] + "_nodes_head_FAL.vtu"
writer = vtk.vtkXMLUnstructuredGridWriter()
