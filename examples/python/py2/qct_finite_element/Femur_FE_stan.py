...
outputFaimFile = os.path.splitext(inputAimFile)[0] + "_STA.inp"
...
outputAimFile = os.path.splitext(inputAimFile)[0] + "_CAL_STA.AIM"
...
outputModelFile = os.path.splitext(inputAimFile)[0] + "_model_STA.vtu"
...
nodesFileShaft = os.path.splitext(inputAimFile)[0] + "_shaft_nodes_STA.vtu"
...
# Save to file so we can examine in ParaView, etc...
depthFilteredBoneNodesFile = os.path.splitext(inputAimFile)[0] + "_nodes_head_STA.vtu"
writer = vtk.vtkXMLUnstructuredGridWriter()
