...
#
# Description:
#   This file creates an image 'wall.aim' which is white (value 127) in the
#   negative x and black (value 0) in the positive x.
#
# Notes:
...
outputFile = os.path.join(outputDirectory, 'wall.aim')
IMAGE_VALUE = 127
M = 100
...
cellmap[0:M, 0:M, 0:M/2] = IMAGE_VALUE
