...
### Checking your Conda version

These are mainly for Mac users caught between Intel and M-processors... Make sure you are the correct Conda version on your MacOS with an M-processor (i.e., osx-arm64).

```commandline
conda config --show subdir
```
Arm-based chips (M1, M2, etc) should output `osx-arm64` and Intel-based chips should output `osx-64`.

Reinstall Conda if you have the wrong version. Directions to safely uninstall can be found here: https://www.anaconda.com/docs/getting-started/anaconda/uninstall
...
| `blImageMask`                  | read an image and apply a mask to keep image information under mask and discard the rest                                                                                                                           |
...
| `blImageCheckerBoard`          | used to compare two images for successful registration                                                                                                                                                             |
